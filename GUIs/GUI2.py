...
def pattern2(poi_color, trail_color, hand):
    ...
    return {
        ...
        "num_frames": num_frames,
        "trail_length": trail_length,
        'poi_head': (antispin_head_x2, antispin_head_y2),
    }
...
def pattern3(poi_color, trail_color, hand):
    ...
    return {
        ...
        "num_frames": num_frames,
        "trail_length": trail_length,
        'poi_head': (antispin_head_x, antispin_head_y),
    }
...
def submit():
    ...
    pattern_data1 = patterns[selected_pattern1](poi_color1, trail_color1, hand1)
    pattern_data2 = patterns[selected_pattern2](poi_color2, trail_color2, hand2)
...
def overlay_patterns(pattern_data1, pattern_data2):
    ...
    def update(frame):
        ...
        poi1_tether.set_data([0, pattern_data1['poi_head'][0][frame]],
                             [0, pattern_data1['poi_head'][1][frame]])
        ...
        poi2_tether.set_data([0, pattern_data2['poi_head'][0][frame]],
                             [0, pattern_data2['poi_head'][1][frame]])

        return poi1_head, poi1_trail, poi1_tether, poi2_head, poi2_trail, poi2_tether
...
ttk.Combobox(root, textvariable=pattern_var1, values=("Pattern 1", "Pattern 2", "Pattern 3", "Pattern 4")).grid(row=0, column=1)
...
ttk.Label(root, text="Hand 1").grid(row=3, column=0, sticky=tk.W)
hand_var1 = tk.StringVar(root)
hand_var1.set("Both") # Set default hand
ttk.Combobox(root, textvariable=hand_var1, values=("Left", "Right", "Both")).grid(row=3, column=1)
...
ttk.Combobox(root, textvariable=pattern_var2, values=("Pattern 1", "Pattern 2", "Pattern 3", "Pattern 4")).grid(row=4, column=1)
...
ttk.Label(root, text="Hand 2").grid(row=7, column=0, sticky=tk.W)
hand_var2 = tk.StringVar(root)
hand_var2.set("Both") # Set default hand
ttk.Combobox(root, textvariable=hand_var2, values=("Left", "Right", "Both")).grid(row=7, column=1)
