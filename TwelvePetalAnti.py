...
def generate_TwelvePetalAnti(fig, ax, head_color, handle_color, start_side='left', rotation_direction='clockwise'):
    # Parameters
    num_frames = 360
    ...
    theta_2 = np.linspace(0, rotation_direction_multiplier * -12 * np.pi, num_frames)
    ...
    title = "12 Petal Antispin (Gunslinger)"
    xlabel= "Head Leading"
    ax.set_xticks([])
    ax.set_yticks([])
