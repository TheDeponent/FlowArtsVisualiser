...
def generate_EightPetalIn(fig, ax, head_color, handle_color, start_side='left', rotation_direction='clockwise'):
    # Parameters
    num_frames = 360
    ...
    theta_2 = np.linspace(0, 10 * rotation_direction_multiplier * np.pi, num_frames)
