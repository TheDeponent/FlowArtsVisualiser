...
def generate_FourPetalInspin(fig, ax, head_color, handle_color, start_side='left', rotation_direction='clockwise'):
    # Parameters
    num_frames = 360
    ...
    theta_2 = 5 * theta_1  # Multiply by 5 for 6 spins per circle (6 - 1)
